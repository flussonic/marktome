...
// blocks.
func NewHTMLBlockParser() parser.BlockParser {
...
func (b *htmlBlockParser) Continue(node ast.Node, reader text.Reader, pc parser.Context) parser.State {
...
func (b *htmlBlockParser) Close(node ast.Node, reader text.Reader, pc parser.Context) {
	// nothing to do
}
